...
function getFirstElement(numArr) {
    return numArr[0];
}
const numbers = [1, 2, 3];
...
const blogResponse = {
    data: {
        ...
        description: "TypeScript is a superset of JavaScript that adds static types to the language that can check the errors in our code during development",
    },
    like: 1,
};
